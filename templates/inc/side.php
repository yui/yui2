...
$nav[]=array('yui','http://developer.yahoo.com/yui/','Home (external)', 'The Yahoo! User Interface Library (YUI)');
...
$nav[]=array('carousel',$docroot.'examples/carousel/index.html','Carousel', 'The YUI Carousel Control - Functional Examples');
...
$nav[]=array('cookie',$docroot.'examples/cookie/index.html','Cookie', 'The YUI Cookie Utility - Functional Examples');
...
$nav[]=array('datatable',$docroot.'examples/datatable/index.html','DataTable', 'The YUI DataTable Control - Functional Examples');
...
$nav[]=array('imagecropper',$docroot.'examples/imagecropper/index.html','ImageCropper', 'The YUI ImageCropper Control - Functional Examples');
...
$nav[]=array('layout',$docroot.'examples/layout/index.html','Layout Manager', 'The YUI Layout Manager - Functional Examples');
...
$nav[]=array('paginator',$docroot.'examples/paginator/index.html','Paginator', 'The YUI Paginator - Functional Examples');
$nav[]=array('profiler',$docroot.'examples/profiler/index.html','Profiler', 'The YUI Profiler Utility - Functional Examples');
$nav[]=array('profilerviewer',$docroot.'examples/profilerviewer/index.html','ProfilerViewer', 'The YUI ProfileViewer Control - Functional Examples');
$nav[]=array('resize',$docroot.'examples/resize/index.html','Resize', 'The YUI Resize Utility - Functional Examples');
$nav[]=array('editor',$docroot.'examples/editor/index.html','Rich Text Editor', 'The YUI Rich Text Editor - Functional Examples');

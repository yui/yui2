...
the menu.  The "lazyload" property is set to "true" to help speed up the 
initial load time of the Menu instance by deferring the initialization and 
rendering of each submenu until just before it is initially made visible.  
Lastly, the effect configuration property is set to use the 
<a href="../../docs/YAHOO.widget.ContainerEffect.html#FADE">pre-canned FADE 
ContainerEffect instance</a> bundled with the Container Core package 
to animate each submenu's opacity as it is shown and hidden.
</p>
<p>

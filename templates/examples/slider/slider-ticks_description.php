<h2 class="first">Building a Horizontal Slider</h2>
...
<ul>
    ...
    <li>We use the Sam skin for a 200px horizontal slider and use the <code>thumb-n.gif</code> thumb image from the build assets</li>
    <li>The background element is assigned a new image from the build assets.</li>
    <li>If the slider background can receive focus, the arrow keys can be used to change this slider's value.</li>
    <li>We use an <code>&lt;img&gt;</code> element rather than a CSS background for the thumb to get around a performance bottleneck when animating the thumb's position in IE.</li>
...
#slider-bg {
    background:url(http://yui.yahooapis.com/<?php echo($yuiCurrentVersion); ?>/build/slider/assets/bg-fader.gif) 5px 0 no-repeat;
}
</textarea>
...
<div id="slider-bg" class="yui-h-slider" tabindex="-1" title="Slider">
    <div id="slider-thumb" class="yui-slider-thumb"><img src="http://yui.yahooapis.com/<?php echo($yuiCurrentVersion); ?>/build/slider/assets/thumb-n.gif"></div>
</div>

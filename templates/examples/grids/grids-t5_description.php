...
<p>The final step is to decide which Preset Template you wish to use, and to apply the corresponding class to a containing <code>div</code>. In this case I've chosen the <code>.yui-t5</code> class, which makes the narrow non-main column 240px and on the right side.</p>
...
<p>Open this example in a new window to see the <code>div.yui-t5</code> which is a right-aligned narrow column of 240px.</p>
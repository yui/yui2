...
<h2>Here is the markup for a Special Nesting Grid B</h2>
...
<p>The above markup will create three units that each take up one third of the available space offered by their parent (minus a gutter).</p>
...
<p>This example showcases the Special Nesting Grid B (<code>div.yui-gb</code>).</p>
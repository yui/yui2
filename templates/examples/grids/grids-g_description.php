...
<p>The above markup will create two units that each take up 50% of the available space offered by their parent (minus a gutter between them).</p>
...
<p>This example showcases the Standard Nesting Grid (<code>div.yui-g</code>).</p>
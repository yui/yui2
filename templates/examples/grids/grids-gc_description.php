...
<h2>Here is the markup for Special Nesting Grid C</h2>
...
<p>The above markup will create two units. The first will take up two thirds of the space; the second will take up one third of the available space offered by their parent (minus a gutter between them).</p>
...
<p>This example showcases the Special Nesting Grid C (<code>div.yui-gc</code>).</p>
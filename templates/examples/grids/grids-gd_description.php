...
<h2>Here is the markup for Special Nesting Grid D</h2>
...
<p>The above markup will create two units. The first takes up one third; the second takes up two thirds of the available space offered by their parent (minus a gutter between them).</p>
...
<p>This example showcases the Special Nesting Grid D (<code>div.yui-gd</code>).</p>
<h2 class="first">Implementing the Menu Style</h2>

<p>The key change we've made in this <a href="http://developer.yahoo.com/yui/treeview/">TreeView Control</a> example is that we've applied a supplementary CSS file to create the "Menu Style" node presentation:</p>

<textarea name="code" class="HTML" cols="60" rows="1"><link rel="stylesheet" type="text/css" href="<?php echo $assetsDirectory; ?>css/menu/tree.css"></textarea>

<p>This CSS redefines the look of branch nodes so they appear as arrows.  The folder-style CSS accompanies your <a href="http://developer.yahoo.com/yui/download/">YUI download</a> and can be found in the <code>yui/examples/treeview/assets</code> directory.</p>

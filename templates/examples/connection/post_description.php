...
<p>
Call <code>YAHOO.util.Connect.asyncRequest</code> to send the request to post.php, and the PHP script will return the a readable output of <code>$_POST</code> via <code>print_r()</code>. The <code>handleSuccess<code></code></code> callback will print the response object's properties, including the server response data.
</p>

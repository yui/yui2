...
$modules["connection"] = array(
							...
							"description" => "<p>The YUI Connection Manager provides support for XMLHttpRequest transactions using a convenient interface normalized across the A-Grade browsers.  Connection Manager also supports file uploads using the same interface.</p>", /*this description appears on the component's examples index page; USE COMPLETE MARKUP...THE FORMATTING SCRIPT WILL NOT WRAP THIS IN <P> TAGS, AS THERE MAY BE MORE THAN ONE PARAGRAPH.*/
							"cheatsheet" => true
						);
...
$examples["get"] = array(
	...
	description => "Uses Connection Manager to demonstrate an HTTP GET request.", /*use this as a tease; e.g., for a tooltip hover; it appears next to the example title on component example index pages.*/

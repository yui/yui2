...
$modules["event"] = array(
							"name" => "Event Utility",
							"type" => "core",
							"description" => "<p>The YUI Event Utility is part of YUI's core, and it provides DOM event management, a custom event system, and page-load timing events that are at the heart of almost any YUI implementation.</p>", /*this description appears on the component's examples index page*/
							"cheatsheet" => true
						);	
...
$examples["event-timing"] = array(
	name => "Using onAvailable, onContentReady, and onDOMReady",
	modules => array("event"),

	...
	var loader = new YAHOO.util.YUILoader({
		...
		onSuccess: function() {
			...
			var launchReadme = function(e) {
				...
				if(readmePanel) {
					...
					try {
						...
						readmePanel.setFooter("[<a href='/yui/build/" + componentName + "/README'>direct link to release notes</a>]");
						...
						$c.asyncRequest("GET", "/yui/build/" + componentName + "/README", {
						...
						location.href="/yui/build/" + componentName + "/README";
					}
			}
			...
			var processFailedXHR = function(o) {
				location.href="/yui/build/" + o.argument.componentName + "/README";	
			}

			...
			<p>The first step to subclassing the Panel is writing the constructor for the new subclass (PhotoBox, in this case), and setting the new class up to extend the Panel class using <em>YAHOO.extend</em>:</p>

			<p>Panels can be skinned using only CSS, and a bit of extra markup. In the previous <a href="../skin/">Skinning Tutorial</a>, we covered the basics of skinning Panels using CSS.</p>

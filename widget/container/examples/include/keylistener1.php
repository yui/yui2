			...
			<p>In this tutorial, we will two KeyListeners: one that will hide a Panel when the escape key is pressed, and one that will show the Panel when the user presses Ctrl+Y. First, we will create a basic Panel and a KeyListener to enable when the Panel is visible.</p>

...
* @class
* A collection of OverlayEffect classes specifically used for animating Panels.
*/
YAHOO.widget.PanelEffect = function() { }

/**
* A pre-configured OverlayEffect instance that can be used for expanding the Panel body vertically
...
YAHOO.widget.PanelEffect.BODY_EXPAND_V = function(overlay, dur) {
	...
	var expand = new YAHOO.widget.OverlayEffect(overlay, { attributes:{height: {from:0, to:(offsetHeight-parseInt(padTop)-parseInt(padBottom))}}, duration:dur, method:YAHOO.util.Easing.easeIn }, { attributes:{height: {to:0}}, duration:dur, method:YAHOO.util.Easing.easeOut}, overlay.body );
...
/**
* A pre-configured OverlayEffect instance that can be used for expanding the Panel horizontally
* @param {Panel}	The Panel object to animate
* @param {float}	The duration of the animation
* @type OverlayEffect
*/
YAHOO.widget.PanelEffect.EXPAND_H = function(overlay, dur) {
	...
	var expand = new YAHOO.widget.OverlayEffect(overlay, { attributes:{width: {from:0, to:parseInt(initialWidth), unit:"em" }}, duration:dur, method:YAHOO.util.Easing.easeIn }, { attributes:{width: {to:0, unit:"em"}}, duration:dur, method:YAHOO.util.Easing.easeOut}, overlay.innerElement );
...
/**
* A pre-configured OverlayEffect instance that can be used for expanding the Panel vertically
* @param {Panel}	The Panel object to animate
* @param {float}	The duration of the animation
* @type OverlayEffect
*/
YAHOO.widget.PanelEffect.EXPAND_V = function(overlay, dur) {
	...
	var expand = new YAHOO.widget.OverlayEffect(overlay, { attributes:{height: {from:0, to:offsetHeight}}, duration:dur, method:YAHOO.util.Easing.easeIn }, { attributes:{height: {to:0}}, duration:dur, method:YAHOO.util.Easing.easeOut}, overlay.innerElement );

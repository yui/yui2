...
YAHOO.lang.JSON = function () {
    var l = YAHOO.lang,
        ...
        // Regex used to encode strings as save JSON values
        str_re = /["\\\x00-\x1f]/g,
    ...
    // String treatment - used for object keys and string values
    function _string(o) { return '"' + o.replace(str_re, _encodeChar) + '"'; }
    
    // Worker method for stringify
    function _stringify(o,w,d) {
        ...
        if (t === 'boolean' || (t === 'object' && o instanceof Boolean)) {
            return String(o);
        }

        // native number and Number instance
        if (t === 'number' || (t === 'object' && o instanceof Number)) {

...
#dragDiv1 { 
    ...
    background-color:#6D739A;top:240px; left:105px;height:7px;width:7px
}

#dragDiv2 { 
    background:url(img/sq2.png) 0 0 no-repeat;
    background-color:#566F4E;top:350px; left:215px;height:7px;width:7px
}

#dragDiv3 {
    background:url(img/sq3.png) 0 0 no-repeat;
    background-color:#7E5B60;top:460px; left:325px;height:7px;width:7px
}
...
?>
<div id="dragDiv1" class="testSquare" tabindex="1">YAHOO.util.DD</div>
